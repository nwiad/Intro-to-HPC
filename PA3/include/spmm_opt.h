...
private:
    ...
    int *pad_idx; // padded column index
    float *pad_val; // padded non-zero value
    int *d_rowptr; // row pointer of non-zero value
    int *d_rowidx; // sorted row index
    int *d_lcol; // leftmost column index
};
#endif